  ...
  <body>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbar-dropdown-menu">
                <a class="dropdown-item" href="apeo_login.html">APEOs</a>
    ...
    <div class="container">
      <div class="jumbotron">
        ...
        <p><a href="detail.html">Click Here</a> to know the details for Booking the field.</p>
        ...
        <div class="checkbox">
          <label>
            <input type="checkbox"> All the details filled are correct
          </label>
        </div>
